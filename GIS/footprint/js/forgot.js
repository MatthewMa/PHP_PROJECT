...
function init() {
   ...
   $("#loginUser").css("position","absolute");
	...
	$("#sitemapContent").html("<a href='index.php'>&nbsp&nbsp&nbsp&nbspHome</a> / Forgot");
...
if (window.XMLHttpRequest) {
  ...
  xmlhttp.onreadystatechange = function() {
    ...
    if (xmlhttp.readyState==4 && xmlhttp.status==200) {
       ...
       $("#errorLogin").css("visibility","visible");$("#errorLogin").html(strFeedback);
    }

  }
  
  xmlhttp.open("GET","php/getPassword.php?p1="+$("#txtUser").val().trim() + "&p2=" + $("#txtEmail").val().trim(),true);
  
  //alert("php/getPassword.php?p1="+$("#txtUser").val().trim() + "&p2=" + $("#txtEmail").val().trim());
