...
function init() {
    ...
    $("#divContact").css("position","absolute");
    $("#divContact").css("top",(TopHeight + mapsiteHeight + margin).toString() + "px"); 
    $("#divContact").css("height", contactHeight.toString());
    $("#divContact").css("backgroundColor","#E5E8C1");
    $("#divContact").css("font","13px arial,serif");
    $("#divContact").css("width",contactWidth.toString());   
    $("#divContact").css("left",((wWidth - contactWidth)/2).toString() + "px");
    $("#divContact").css("border","1px solid #ff9900");
	...
	$("#sitemapContent").html("<a href='index.php'>&nbsp&nbsp&nbsp&nbspHome</a> / Contact");
