...
function init() {
    ...
    $("#dashboard").css("backgroundColor","#E5E8C1"); 
    $("#dashboard").css("top", (TopHeight + margin).toString() + "px");
    $("#dashboard").css("height",dbHeight.toString());
    $("#dashboard").css("left",(boundary).toString() + "px");
    $("#dashboard").css("width",dbWidth.toString());
    ...
    //$("#divLogin").css("border","1px solid #ff9900");
